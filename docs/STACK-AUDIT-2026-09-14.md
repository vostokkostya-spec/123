...
- CI was green for the hybrid routing changes.
...
3. Add persistent task history only after defining retention and redaction rules.
4. Replace beginning-only truncation with chunking or a head/tail strategy.
